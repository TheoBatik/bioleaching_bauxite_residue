...
base_dir = '/home/theodore/personal/bioleaching_bauxite_residue/archive' # os.getcwd()
...
A, A_header = load_csv('1_A')
B, B_header = load_csv('1_B')
...
np.savetxt('B.csv', B, delimiter=',', fmt='%.2f')
